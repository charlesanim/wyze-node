...
async function main() {
  ...
  if (!email || !password) {
    console.error('Usage: WYZE_EMAIL=you@email.com WYZE_PASSWORD=yourpass node tools/vacuum-controller.js')
    process.exit(1)
  }

  const wyze = new Wyze({ username: email, password: password })
